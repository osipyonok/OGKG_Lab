...
namespace geometry
{
        ...
        InputIterator end)
    {
        ...
        for (; begin != end; ++begin)
        {
			...
			//qDebug() << "Before computing orientation\n";
            auto pab = compute_orientation(point, segment.a, segment.b);
			//qDebug() << "After computing orientation\n";
